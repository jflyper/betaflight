...
#define TARGET_BOARD_IDENTIFIER "H745"
#define USBD_PRODUCT_STRING "Nucleo-H745"

#define USE_TARGET_CONFIG

#define LED0_PIN                PB0
#define LED1_PIN                PB7 // PE1 on NUCLEO-H745ZI-Q (may collide with UART8_TX)
//#define LED2_PIN                PB14 // SDMMC2_D0

// Nucleo-H745 has one button (The blue USER button).
...
#if !defined(NUCLEOH745_RAMBASED)
