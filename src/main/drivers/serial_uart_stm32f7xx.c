...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
...
#ifdef USE_UART7
    {
        ...
        .rxDMAInstance = DMA1_Stream3,
#endif
#ifdef USE_UART7_TX_DMA
        .txDMAInstance = DMA1_Stream1,
#endif
        .rxPins = {
...
#ifdef USE_UART8
    {
        ...
        .rxDMAInstance = DMA1_Stream6,
#endif
#ifdef USE_UART8_TX_DMA
        .txDMAInstance = DMA1_Stream0,
#endif
        .rxPins = {
...
void uartIrqHandler(uartPort_t *s)
{
    ...
    if (!s->txDMAInstance && (__HAL_UART_GET_IT(huart, UART_IT_TXE) != RESET)) {
