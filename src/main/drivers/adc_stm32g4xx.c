...
// XXX Instance and DMA channel defs will be gone in unified target
...
#endif
#ifndef ADC4_INSTANCE
#define ADC4_INSTANCE NULL
#endif
#ifndef ADC5_INSTANCE
#define ADC5_INSTANCE NULL
#endif
