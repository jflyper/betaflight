...
uint32_t dmaFlag_IT_TCIF(const dmaInstance_t *channel)
{
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 1);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 2);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 3);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 4);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 5);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 6);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 1, 7);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 2, 1);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 2, 2);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 2, 3);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 2, 4);
    RETURN_TCIF_FLAG((DMA_INSTANCE_TYPE *)channel, 2, 5);
    return 0;
}
