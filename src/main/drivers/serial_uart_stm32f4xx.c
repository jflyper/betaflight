...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
#ifdef USE_UART1
    {
        ...
        .rxDMAInstance = DMA2_Stream5,
#endif
#ifdef USE_UART1_TX_DMA
        .txDMAInstance = DMA2_Stream7,
#endif
...
#ifdef USE_UART2
    {
        ...
        .rxDMAInstance = DMA1_Stream5,
#endif
#ifdef USE_UART2_TX_DMA
        .txDMAInstance = DMA1_Stream6,
#endif
...
#ifdef USE_UART3
    {
        ...
        .rxDMAInstance = DMA1_Stream1,
#endif
#ifdef USE_UART3_TX_DMA
        .txDMAInstance = DMA1_Stream3,
#endif
...
#ifdef USE_UART4
    {
        ...
        .rxDMAInstance = DMA1_Stream2,
#endif
#ifdef USE_UART4_TX_DMA
        .txDMAInstance = DMA1_Stream4,
#endif
...
#ifdef USE_UART5
    {
        ...
        .rxDMAInstance = DMA1_Stream0,
#endif
#ifdef USE_UART5_TX_DMA
        .txDMAInstance = DMA1_Stream7,
#endif
...
#ifdef USE_UART6
    {
        ...
        .rxDMAInstance = DMA2_Stream1,
#endif
#ifdef USE_UART6_TX_DMA
        .txDMAInstance = DMA2_Stream6,
#endif
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (hardware->rxDMAInstance) {
        dmaInit(dmaGetIdentifier(hardware->rxDMAInstance), OWNER_SERIAL_RX, RESOURCE_INDEX(device));
    ...
    if (hardware->txDMAInstance) {
        const dmaIdentifier_e identifier = dmaGetIdentifier(hardware->txDMAInstance);
...
{
    if (!s->rxDMAInstance && (USART_GetITStatus(s->USARTx, USART_IT_RXNE) == SET)) {
    ...
    if (!s->txDMAInstance && (USART_GetITStatus(s->USARTx, USART_IT_TXE) == SET)) {
