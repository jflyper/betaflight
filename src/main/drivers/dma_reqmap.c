...
#define DMA(d, s) { DMA_CODE(d, s, 0), (dmaInstance_t *)DMA ## d ## _Stream ## s, 0 }
...
#if defined(STM32F4)
#define DMA(d, s, c) { DMA_CODE(d, s, c), (dmaInstance_t *)DMA ## d ## _Stream ## s, DMA_Channel_ ## c }
...
#define DMA(d, c) { DMA_CODE(d, 0, c), (dmaInstance_t *)DMA ## d ## _Channel ## c }
