...
#define SDIO_CLK        IO_CONFIG(GPIO_Mode_AF, GPIO_Speed_100MHz, GPIO_OType_PP, GPIO_PuPd_NOPULL)
    ...
    if ((uint32_t)dma_stream == (uint32_t)DMA2_Stream3) {
        ...
        dmaSetHandler(dmaGetIdentifier((dmaInstance_t *)DMA2_Stream3), SDIO_DMA_ST3_IRQHandler, 1, 0);
    } else {
        ...
        dmaSetHandler(dmaGetIdentifier((dmaInstance_t *)DMA2_Stream6), SDIO_DMA_ST6_IRQHandler, 1, 0);
    }
}
