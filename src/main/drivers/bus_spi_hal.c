...
void spiSetDivisor(SPI_TypeDef *instance, uint16_t divisor)
{
    ...
    case 8:
        spi->hspi.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_8;
        break;

    case 16:
        spi->hspi.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_16;
        break;
    ...
    case 64:
        spi->hspi.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_64;
        break;
