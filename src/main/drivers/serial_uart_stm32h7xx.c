...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
#ifdef USE_UART1
    {
        ...
        .rxDMAInstance = UART1_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_USART1_TX,
        .txDMAInstance = UART1_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART2
    {
        ...
        .rxDMAInstance = UART2_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_USART2_TX,
        .txDMAInstance = UART2_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART3
    {
        ...
        .rxDMAInstance = UART3_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_USART3_TX,
        .txDMAInstance = UART3_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART4
    {
        ...
        .rxDMAInstance = UART4_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_UART4_TX,
        .txDMAInstance = UART4_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART5
    {
        ...
        .rxDMAInstance = UART5_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_UART5_TX,
        .txDMAInstance = UART5_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART6
    {
        ...
        .rxDMAInstance = UART6_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_USART6_TX,
        .txDMAInstance = UART6_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART7
    {
        ...
        .rxDMAInstance = UART7_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_UART7_TX,
        .txDMAInstance = UART7_TX_DMA_STREAM,
#endif
        .rxPins = {
...
#ifdef USE_UART8
    {
        ...
        .rxDMAInstance = UART8_RX_DMA_STREAM,
        .txDMARequest = DMA_REQUEST_UART8_TX,
        .txDMAInstance = UART8_TX_DMA_STREAM,
#endif
        .rxPins = {
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
...
#ifdef USE_DMA
    if (hardware->rxDMAInstance) {
        s->rxDMAInstance = hardware->rxDMAInstance;
#if defined(STM32H7)
    ...
    if (hardware->txDMAInstance) {
        s->txDMAInstance = hardware->txDMAInstance;
#if defined(STM32H7)
        ...
        // DMA TX Interrupt
        dmaIdentifier_e identifier = dmaGetIdentifier(hardware->txDMAInstance);
