...
#define SDMMC_CLK        IO_CONFIG(GPIO_MODE_AF_PP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_NOPULL)
    ...
    if ((uint32_t)dma_stream == (uint32_t)DMA2_Stream3) {
        ...
        dmaInit(dmaGetIdentifier((dmaInstance_t *)DMA2_Stream3), OWNER_SDCARD, 0);
        dmaSetHandler(dmaGetIdentifier((dmaInstance_t *)DMA2_Stream3), SDMMC_DMA_ST3_IRQHandler, 1, 0);
    } else {
        ...
        dmaInit(dmaGetIdentifier((dmaInstance_t *)DMA2_Stream6), OWNER_SDCARD, 0);
        dmaSetHandler(dmaGetIdentifier((dmaInstance_t *)DMA2_Stream6), SDMMC_DMA_ST6_IRQHandler, 1, 0);
    }
}
